...
const DailyDashboard = ({ userData }) => {
  ...
  const downloadExcel = () => {
    ...
    const finalSummaryData = [
      ...
      ["", 12],
      ["Category Checks", ""],
      ["Sites Less Than 12 Hrs Diesel Back Up", 0],
      ["Sites More Than 12 Hrs Diesel Back Up", 1],
      ["MSC more than 2500 Litres excluding Day Tanks", 0],
      ["MSC more than 2500 Litres Including Day Tanks", 0],
      ["DG Running Hrs.", 0.3],
      ["EB Availability Hrs.", 23.7],
      ["Infra Uptime", "100%"],
    ...
    const finalSummarySheet = XLSX.utils.aoa_to_sheet(finalSummaryData);
    XLSX.utils.book_append_sheet(wb, finalSummarySheet, "Final Summary");
    ...
    XLSX.writeFile(wb, `WB_Daily_Details_Dashboard_on_${selectedDate}.xlsx`);
  };
