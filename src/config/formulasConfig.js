...
export const formulasConfig = {
  ...
  Final_Summary: [
    ...
    { Edge_Data_Centres_Count: "Sites Less Than 12 Hrs Diesel Back Up", WB: "=COUNTIF(Diesel_Back_Up.Fuel_back_up_Hrs_ARRAY, \"<\", 12)" },
    { Edge_Data_Centres_Count: "Sites More Than 12 Hrs Diesel Back Up", WB: "=COUNTIF(Diesel_Back_Up.Fuel_back_up_Hrs_ARRAY, \">\", 12)" },
