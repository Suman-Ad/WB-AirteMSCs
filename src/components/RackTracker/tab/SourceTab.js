            ...
            <div className="form-section" style={{ flex: 1 }}>
                <div className="chart-container" style={{ paddingBottom: "10px", display: "normal", border: "2px solid #2083a1ff", marginTop: "20px" }}>
                    ...
                    <div>
                        ...
                        <label style={{ color: "#2083a1ff", fontWeight: "bold" }}>{sourceTitle} PP - DB Cable Size (Sq mm):</label>
                        ...
                        <label style={{ color: "#2083a1ff", fontWeight: "bold" }}>{sourceTitle} PP - DB Cable Length (mtr):</label>
                    ...
                    <div style={{ borderTop: "2px solid #fffffff3", padding: "5px" }}>
                        <label>{sourceTitle} Cable Load Capacity (Amps):</label>
